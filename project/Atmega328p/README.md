...
스테핑모터 핀 정리 (PORTC 0\~3, PORTD 2\~5)  
...
서보모터를 쉽게 쓰기 위해 써둔 매크로.  

SERVO_A(1)은 pca9685의 0번 핀을 뜻하고  
SERBO_B(3)은 pca9685의 10번 핀을 뜻한다.  
...
raspberry pi에서 분류한 red, blue, green box의 갯수를 저장해놓는 변수,  
uart를 사용하기 위한 변수를 지역변수가 아닌 전역변수로 선언.
...
스테핑모터를 돌리는 [코드](https://github.com/ndg5778/smartfactory/blob/main/test/atmega/L298N/L298N.c)  
