...
//uint16_t move_Aarm_coord[9][servo_max_A][3] = {
	...
	//{
		///* 01 */
		//{1, 90, 83.7}, {4, 90, 135}, {2, 90, 60}, {3, 90, -10}, {4, 135, 110}, {5, 50, 30},
	...
	//{
		///* 08 */
		//{1, 90, 64}, {4, 90, 180}, {2, 90, 45}, {3, 90, 17}, {4, 180, 110}, {5, 45, 10},
...
//int WhichCanMove(void) {
	...
	//while (pass == 0){
		...
		//if(process_data == 1){
			...
			//
			//// 0 ~ 8의 값이 들어오면
			//else if ((strcmp(buffer_data, "0") == 0) || (strcmp(buffer_data, "1") == 0) || (strcmp(buffer_data, "2") == 0) || (strcmp(buffer_data, "3") == 0) || (strcmp(buffer_data, "4") == 0) || (strcmp(buffer_data, "5") == 0) || (strcmp(buffer_data, "6") == 0) || (strcmp(buffer_data, "7") == 0) || (strcmp(buffer_data, "8") == 0) || (strcmp(buffer_data, "9") == 0)) {
				...
				//else if ((strcmp(buffer_data, "9") == 0)) return 9;
			//}
			//// 다른 값이 들어온다면...
			//else {
