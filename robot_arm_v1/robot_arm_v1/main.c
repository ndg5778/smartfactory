...
//
		...
		//while (pass == 0) {
			...
			//if (part == 1){
				...
				////if (strcmp(uart_temp, "fisrt_robot_stop") == 0) {
					////PORTB |= (1 << LED2);
			...
			//if (part == 2) {
				...
				//if (strcmp(temp, "conveyor_stp") == 0) {
					...
					//return 0;
				//}
				//else if (strcmp(temp, "conveyor_go") == 0){
					//part = 3;
				//}
			//}
			//
...
//}
//
//const char* ReceiveInfrared (void) {
	//
	//int pass = 0;
	//char temp[20];
	//
	//while (pass == 0){
		...
		//if(process_data == 1){
			...
			//if (strcmp(buffer_data, "go") == 0) {
				//UART_printString("conveyor belt start");
				//PORTB &= ~(1 << LED1);
				//strcpy(temp, "conveyor_go");
				//return temp;
			//}
			//
